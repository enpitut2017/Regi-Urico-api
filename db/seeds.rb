...
touhou.event_items.create!(price: 1400, item: tg1)
touhou.event_items.create!(price: 600, item: tc1)
comcity.event_items.create!(price: 800, item: tc1)
comcity.event_items.create!(price: 100, item: zc1)
comcity.event_items.create!(price: 200, item: kbc1)
comcity.event_items.create!(price: 700, item: hrakc2)
kurobasu.event_items.create!(price: 200, item: kbc1)
kurobasu.event_items.create!(price: 800, item: kbc2)
onepeace.event_items.create!(price: 0, item: opc1)
onepeace.event_items.create!(price: 400, item: opa1)

hrak.event_items.create!(price: 800, item: hrakc1)
hrak.event_items.create!(price: 600, item: hrakc2)
yugio.event_items.create!(price: 300, item: ygc1)
yugio.event_items.create!(price: 600, item: yga1)
naruto.event_items.create!(price: 1400, item: nc1)
naruto.event_items.create!(price: 800, item: nc2)
naruto.event_items.create!(price: 300, item:na1)
singeki.event_items.create!(price: 100, item: sgc1)
singeki.event_items.create!(price: 200, item: sgc2)
singeki.event_items.create!(price: 2000, item: sgg1)
# event_item_id: 1-20
